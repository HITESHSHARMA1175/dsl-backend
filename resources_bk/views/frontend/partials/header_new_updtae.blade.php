    ...
    <nav class="nav" aria-label="Primary navigation">
      <ul class="nav__list">
        ...
        <li class="nav__item has-submenu has-mega">
          <a class="nav__link nav__link--treatments" href="service-details-page.php" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="mega-menu" aria-label="Treatments mega menu">
            <div class="mega-menu__inner">
              <ul class="mega-menu__tabs" role="list">
                <li class="is-active">
                  <a href="service-details-page.php?slug=injectables" class="mega-tab" data-panel="injectables" aria-current="true">
                ...
                <li>
                  <a href="service-details-page.php?slug=laser-hair-removal" class="mega-tab" data-panel="laser-hair-removal">
                ...
                <li>
                  <a href="service-details-page.php?slug=skin-treatments" class="mega-tab" data-panel="skin-treatments">
                ...
                <li>
                  <a href="service-details-page.php?slug=body-treatments" class="mega-tab" data-panel="body-treatments">
                ...
                <li>
                  <a href="service-details-page.php?slug=laser-tattoo-removal" class="mega-tab" data-panel="laser-tattoo-removal">
              ...
              <div class="mega-menu__content">
                <div class="mega-panel is-active" data-panel="injectables">
                  <div class="mega-col">
                    <h4>COSMETIC INJECTIONS</h4>
                    <a href="#">Anti-Wrinkle for Women</a>
                    <a href="#">Anti-Wrinkle for Men</a>
                    <a href="#">Subscription</a>
                    <a href="#">HarmonyCA</a>
                    <a href="#">Polynucleotides</a>
                    <a href="#">Polynucleotides Hair</a>
                    <a href="#">Profhilo</a>
                    <a href="#">Sculptra</a>
                    <a href="#">SkinVive</a>
                    <a href="#">Sunekos Revive</a>
                  </div>
                  <div class="mega-col">
                    <h4>FILLERS</h4>
                  ...
                  <a class="mega-promo" href="#" style="--promo-bg:url('https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?auto=format&fit=crop&w=900&q=80')">
                    <span class="mega-promo__title">The Injectable Bio-Stimulator</span>
                    <span class="mega-promo__btn">Book Now</span>
                  </a>
                </div>

                <div class="mega-panel" data-panel="laser-hair-removal">
                  <div class="mega-col">
                    <h4>FOR WOMEN</h4>
                    <a href="#">Bikini</a>
                    <a href="#">Face</a>
                  ...
                  <div class="mega-col">
                    <h4>LEARN MORE</h4>
                    <a href="#">About Laser Hair Removal</a>
                    <a href="#">About Laser Hair Removal for Women</a>
                    <a href="#">About Laser Hair Removal for Men</a>
                    <a href="#">Book Free Consultation</a>
                    <a href="#">Pricing for Women</a>
                    <a href="#">Pricing for Men</a>
                  </div>
                  <a class="mega-promo" href="#" style="--promo-bg:url('https://images.unsplash.com/photo-1626430352344-671f98c7dd2a?auto=format&fit=crop&w=900&q=80')">
                    <span class="mega-promo__title">Save on Laser Hair Removal Treatments</span>
                    <span class="mega-promo__btn">View Offers</span>
                  </a>
                </div>

                <div class="mega-panel" data-panel="skin-treatments">
                  <div class="mega-col">
                    <h4>ADVANCED TREATMENTS</h4>
                    <a href="#">Exilis Face</a>
                    <a href="#">Hydrafacial</a>
                    <a href="#">Laser Facial</a>
                    <a href="#">Micro-Needling</a>
                    <a href="#">Morpheus8</a>
                    <a href="#">Potenza</a>
                    <a href="#">Skin Health</a>
                    <a href="#">Skin+ Packages</a>
                    <a href="#">Skin Theory Peels</a>
                    <a href="#">Therascan</a>
                  </div>
                  <div class="mega-col">
                    <h4>SKIN CONCERNS</h4>
                    <a href="#">Acne &amp; Oily Skin</a>
                    <a href="#">Acne Scarring</a>
                    <a href="#">Ageing Skin &amp; Wrinkles</a>
                    <a href="#">Pigmentation &amp; Sun Damage</a>
                    <a href="#">Redness &amp; Sensitivity</a>
                    <a href="#">Rosacea</a>
                  </div>
                  <div class="mega-col">
                    <h4>LEARN MORE</h4>
                  ...
                  <a class="mega-promo" href="#" style="--promo-bg:url('https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=900&q=80')">
                    <span class="mega-promo__title">The Non-Surgical Face Lift</span>
                    <span class="mega-promo__btn">Buy Now</span>
                  </a>
                </div>

                <div class="mega-panel" data-panel="body-treatments">
                  <div class="mega-col">
                    <h4>SCULPTING &amp; TONING</h4>
                    <a href="#">Emsculpt</a>
                    <a href="#">Exilis</a>
                  </div>
                  <div class="mega-col">
                  ...
                  <div class="mega-col">
                    ...
                    <a href="#">Core To Floor</a>
                    <a href="#">Emsella</a>
                    <h4 class="mega-col__spaced">LEARN MORE</h4>
                    <a href="#">Right for You</a>
                    <a href="#">Book Free Consultation</a>
                    <a href="pricing.php">Pricing</a>
                  </div>
                  <a class="mega-promo" href="#" style="--promo-bg:url('https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=900&q=80')">
                    <span class="mega-promo__title">Strengthen Your Pelvic Floor</span>
                    <span class="mega-promo__btn">Buy Now</span>
                  </a>
                </div>

                <div class="mega-panel mega-panel--tattoo" data-panel="laser-tattoo-removal">
                  <a class="mega-promo" href="#" style="--promo-bg:url('https://images.unsplash.com/photo-1598373182133-52452f7691ef?auto=format&fit=crop&w=900&q=80')">
                    <span class="mega-promo__title">Looking for a smarter way to remove tattoos?</span>
...
@endphp
      <div class="header-icons">
        ...
        <div class="lang-switcher" id="langSwitcher">
          <button class="lang-switcher__btn" type="button" aria-label="Choose language" aria-haspopup="true" aria-expanded="false" aria-controls="langSwitcherMenu">
            <span class="lang-switcher__flag" aria-hidden="true">
              <img src="https://flagcdn.com/w40/gb.png" alt="" />
            </span>
            <svg class="lang-switcher__caret" width="12" height="12" viewBox="0 0 12 12" aria-hidden="true">
              <path d="M2 4.5L6 8l4-3.5" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </button>
          <div class="lang-switcher__menu" id="langSwitcherMenu" role="menu" aria-label="Language options">
            <button type="button" role="menuitem" data-language="English">English</button>
            <button type="button" role="menuitem" data-language="Arabic">Arabic</button>
            <button type="button" role="menuitem" data-language="Urdu">Urdu</button>
          </div>
        </div>
      </div>
  ...
  <div class="drawer__panel" role="dialog" aria-modal="true" aria-label="Mobile navigation">
    ...
    <nav class="mnav" aria-label="Mobile navigation">
      ...
      <div class="mnav__submenu" id="m_treatments" hidden>
        <button class="mnav__subtoggle" type="button" aria-expanded="false" aria-controls="m_treat_injectables">Injectables <span aria-hidden="true">▾</span></button>
        <div class="mnav__subpanel" id="m_treat_injectables" hidden>
          <p class="mnav__subheading">Cosmetic Injections</p>
          <a href="#">Anti-Wrinkle for Women</a>
          <a href="#">Anti-Wrinkle for Men</a>
          <a href="#">Subscription</a>
          <a href="#">HarmonyCA</a>
          ...
          <p class="mnav__subheading">Fillers</p>
          <a href="#">Dermal Fillers</a>
          <a href="#">Lip Fillers</a>

          <p class="mnav__subheading">Learn More</p>
          <a href="#">Right for You</a>
          <a href="#">Book Free Consultation</a>
          <a href="pricing.php">Pricing</a>
        </div>

        <button class="mnav__subtoggle" type="button" aria-expanded="false" aria-controls="m_treat_lhr">Laser Hair Removal <span aria-hidden="true">▾</span></button>
        <div class="mnav__subpanel" id="m_treat_lhr" hidden>
          <p class="mnav__subheading">For Women</p>
          <a href="#">Bikini</a>
          <a href="#">Face</a>
          <a href="#">Upper Body</a>
          <a href="#">Lower Body</a>
          ...
          <p class="mnav__subheading">For Men</p>
          <a href="#">Face</a>
          <a href="#">Upper Body</a>
          <a href="#">Lower Body</a>
          <a href="#">Full Body</a>
        ...
        <button class="mnav__subtoggle" type="button" aria-expanded="false" aria-controls="m_treat_skin">Skin Treatments <span aria-hidden="true">▾</span></button>
        <div class="mnav__subpanel" id="m_treat_skin" hidden>
          <p class="mnav__subheading">Advanced Treatments</p>
          <a href="#">Exilis Face</a>
          <a href="#">Hydrafacial</a>
          <a href="#">Laser Facial</a>
          <a href="#">Micro-Needling</a>
          ...
          <p class="mnav__subheading">Skin Concerns</p>
          <a href="#">Acne &amp; Oily Skin</a>
          <a href="#">Acne Scarring</a>
          <a href="#">Ageing Skin &amp; Wrinkles</a>
          <a href="#">Pigmentation &amp; Sun Damage</a>
        ...
        <button class="mnav__subtoggle" type="button" aria-expanded="false" aria-controls="m_treat_body">Body Treatments <span aria-hidden="true">▾</span></button>
        <div class="mnav__subpanel" id="m_treat_body" hidden>
          <p class="mnav__subheading">Sculpting &amp; Toning</p>
          <a href="#">Emsculpt</a>
          <a href="#">Exilis</a>

          <p class="mnav__subheading">Fat Freezing</p>
          <a href="#">Coolsculpting</a>

          <p class="mnav__subheading">Women's Health</p>
          <a href="#">Core To Floor</a>
          <a href="#">Emsella</a>
        ...
        <button class="mnav__subtoggle" type="button" aria-expanded="false" aria-controls="m_treat_tattoo">Laser Tattoo Removal <span aria-hidden="true">▾</span></button>
        <div class="mnav__subpanel" id="m_treat_tattoo" hidden>
          <p class="mnav__subheading">Learn More</p>
      ...
      <div class="mnav__cta">
        <div class="mnav__languages" aria-label="Language selector">
          <button type="button" class="mnav__lang is-active" data-language="English" aria-label="English">
            <img src="https://flagcdn.com/w40/gb.png" alt="" />
            <span>EN</span>
          </button>
          <button type="button" class="mnav__lang" data-language="Arabic" aria-label="Arabic">
            <img src="https://flagcdn.com/w40/ae.png" alt="" />
            <span>AR</span>
          </button>
          <button type="button" class="mnav__lang" data-language="Urdu" aria-label="Urdu">
            <img src="https://flagcdn.com/w40/pk.png" alt="" />
            <span>UR</span>
          </button>
        </div>
        <a class="btn btn--primary header-cta" href="appointment.php">Free Consultation</a>
...
<div class="cart-drawer" id="cartDrawer" aria-hidden="true">
  ...
  <aside class="cart-drawer__panel" role="dialog" aria-modal="true" aria-label="Shopping cart">
    ...
    <div class="cart-drawer__foot">
      ...
      <a class="cart-drawer__cta" href="shop.php">Continue shopping</a>
    </div>
  </aside>
</div>
...
document.addEventListener('keydown', function (e) {
  if (e.key === 'Escape') {
    ...
    //     row.innerHTML = `
    //       <div class="cart-drawer__thumb"><img src="${item.img || ''}" alt="${item.name}"></div>
    //       <div class="cart-drawer__meta">
    //         <p class="cart-drawer__name">${item.name}</p>
    //         <div class="cart-drawer__actions">
    //           <div class="cart-drawer__qty" role="group" aria-label="Quantity">
    //             <button type="button" data-cart-qty="dec" aria-label="Decrease quantity">−</button>
    //             <span aria-live="polite">${qty}</span>
    //             <button type="button" data-cart-qty="inc" aria-label="Increase quantity">+</button>
    //           </div>
    //           <button type="button" class="cart-drawer__remove" data-cart-remove>Remove</button>
    //         </div>
    //       </div>
    //       <div class="cart-drawer__price">${money(price * qty)}</div>
    //     `;

    //     row.querySelector('[data-cart-qty="inc"]').addEventListener('click', () => {
    //       window.DSLCart.updateItemQty(item.name, 1);
    //     });

    //     row.querySelector('[data-cart-qty="dec"]').addEventListener('click', () => {
    //       window.DSLCart.updateItemQty(item.name, -1);
    //     });

    //     row.querySelector('[data-cart-remove]').addEventListener('click', () => {
    //       window.DSLCart.removeItem(item.name);
    //     });
    ...
    //     if (existing) {
    //       existing.qty += Math.max(1, parseInt(item.qty, 10) || 1);
    //     } else {
    //       items.push({
    //         name: String(item.name),
    //         img: item.img ? String(item.img) : '',
    ...
    //     const items = readCart().filter((entry) => entry.name !== name);
    //     persistCart(items);
    //   },
    //   open() {
    //     syncCartUI();
    ...
    //   button.addEventListener('click', () => window.DSLCart.open());
    // });
