...
<main class="signin-page">
  <div class="signin-shell">
    <section class="signin-card" aria-labelledby="signinTitle">
      ...
      <h1 class="signin-title" id="signinTitle">Sign in to continue</h1>
      <p class="signin-subtitle">Welcome back to DSL Clinic USA 🇺🇸</p>

      <form class="signin-form" action="{{ url('login') }}" method="post">
          @csrf
        <div class="signin-field"> 
            <label class="signin-label" for="signinEmail">Email address</label> 
            <input class="signin-input" type="email" id="signinEmail" name="email" placeholder="Enter your email address" value="{{ old('email') }}" required > 
        </div> @error('email') <div style="color:red; margin-bottom:10px;"> {{ $message }} </div> 
        @enderror 
        <!-- Hidden Password --> 
        <input type="hidden" name="password" value="1234"> 
        <button class="signin-btn" type="submit"> 
        @if(session('app_locale')=='cn') جاری رکھیں @elseif(session('app_locale')=='ar') يكمل @else Continue @endif
        </button>

        <div class="signin-divider">OR</div>

        <a class="signin-google" href="#" aria-label="Continue with Google">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path fill="#EA4335" d="M12 10.2v3.9h5.4c-.2 1.2-1.4 3.6-5.4 3.6-3.2 0-5.9-2.7-5.9-6s2.7-6 5.9-6c1.8 0 3 .8 3.7 1.5l2.5-2.4C16.7 3.4 14.6 2.5 12 2.5a9.5 9.5 0 1 0 0 19c5.5 0 9.1-3.8 9.1-9.2 0-.6-.1-1.1-.1-1.6H12Z"/>
            <path fill="#34A853" d="M2.5 7.6l3.2 2.4C6.5 8 9 5.7 12 5.7c1.8 0 3 .8 3.7 1.5l2.5-2.4C16.7 3.4 14.6 2.5 12 2.5 8.3 2.5 5 4.6 3.3 7.7l-.8-.1Z"/>
            <path fill="#FBBC05" d="M12 21.5c2.5 0 4.6-.8 6.2-2.3l-2.9-2.2c-.8.5-1.8.8-3.3.8-3.9 0-5.2-2.6-5.4-3.6l-3.2 2.5C5 19.5 8.3 21.5 12 21.5Z"/>
            <path fill="#4285F4" d="M21.1 12.3c0-.6-.1-1.1-.1-1.6H12v3.9h5.4c-.3 1.4-1.3 2.4-2.1 3l2.9 2.2c1.7-1.5 2.9-3.9 2.9-7.5Z"/>
          </svg>
