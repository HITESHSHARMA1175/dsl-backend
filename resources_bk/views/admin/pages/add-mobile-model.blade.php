            ...
            <div class="main-container container-fluid">
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add Mobile Model</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div>
                                            <!-- <h6 class="main-content-label mb-3">BASIC INFO</h6> </div> -->
                                        <div class="">
                                            <div class="row row-sm">
                                            <div class="col-sm-12 form-group">
                                                    <label class="form-label">Select Mobile Brand: <span class="tx-danger">*</span></label>
                                                    <select class="form-control select select2" name="designation">
                                                        <option value="">Select Mobile Brand</option>
                                                        <option value="4"> Select Mobile Brand </option>
                                                        <option value="5"> Select Mobile Brand </option>
                                                        <option value="6"> Select Mobile Brand </option>
                                                        <option value="7"> Select Mobile Brand </option>
                                                        <option value="2"> Select Mobile Brand </option>
                                                        <option value="3"> Select Mobile Brand </option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-12 form-group">
                                                    <label class="form-label">Enter Mobile Model                                                    : <span class="tx-danger">*</span></label>
                                                    <input class="form-control" name="first_name" value="" placeholder="Enter Mobile Model" type="text"> </div>
                                                ...
                                                <div class="col-lg-6 form-group">
                                                    ...
                                                    <input class="form-control" name="password" value="" placeholder="Enter " type="text"> </div>
                                                ...
                                                <!-- <div class="col-lg-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control fc-datepicker" name="dob" placeholder="MM/DD/YYYY" value="" type="text"> </div>
                                                </div> -->
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!-- <div class="row row-sm">
                            <div class="col-lg-12 col-md-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div>
                                            <h6 class="main-content-label mb-1">Address Details</h6> </div>
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input class="form-control" name="pincode" value="" type="text"> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
