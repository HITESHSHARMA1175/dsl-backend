            ...
            <div class="main-container container-fluid">
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add Mobile Colour</h2>
                            <ol class="breadcrumb">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                    <label class="form-label">Mobile Brand: <span class="tx-danger">*</span></label>
                                                    <select class="form-control select select2" name="designation">
                                                        <option value="">Select Mobile Brand</option>
                                                        <option value="4">  Mobile Brand </option>
                                                        <option value="4">  Mobile Brand </option>
                                                        <option value="4">  Mobile Brand </option>
                                                        <option value="4">  Mobile Brand </option>
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    <label class="form-label"> Mobile Model: <span class="tx-danger">*</span></label>
                                                    <select class="form-control select select2" name="designation">
                                                        <option value="">Select  Mobile Model  </option>                                                      </option>
                                                ...
                                                <div class="col-lg-6 form-group">
                                                    <label class="form-label">Mobile Variant: <span class="tx-danger">*</span></label>
                                                    <input class="form-control" name="first_name" value="" placeholder="Enter Mobile Variant" type="text"> </div>
                                            ...
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input class="form-control" name="Enter Colour Code" value="" type="text"> </div>
                                            </div>
                                                <!-- <div class="col-lg-6 form-group">
