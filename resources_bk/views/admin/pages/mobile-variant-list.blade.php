                            ...
                            <div class="card custom-card">
                                ...
                                <form action="https://admin.dsl.co.in/admin/employee/All%20User" method="get">
                                        <div class="row">
                                            ...
                                            <a href="{{ route('add-mobile-variant') }}" class="btn btn-primary btn-icon-text newbtn">Add New Variant</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end mt-2">
                                        <nav>
                                            <ul class="pagination">
                                                ...
                                                <li class="page-item"><a class="page-link" href="234">234</a></li>
                                                <li class="page-item"><a class="page-link" href="235">235</a></li>
                                                <li class="page-item"> <a class="page-link" href="2" rel="next" aria-label="Next &raquo;">&rsaquo;</a> </li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
