    ...
    <div class="main-content side-content pt-0">
        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <!-- End Page Header -->
                <form action="{{ route('concern.update', $concern_info->id) }}" method="post"
                                        ...
                                        <div class="">
                                            <div class="row row-sm">
                                                <div class="col-lg-4 form-group">
                                                    ...
                                                    <select class="form-control select select2" name="concern_types" required>
                                                        <option value="">Select</option>
                                                        @foreach ($concern_types as $item)
                                                            <option value="{{ $item->id }}" {{ $concern_info->concern_types == $item->id ? 'selected' : '' }}>{{ $item->MasterValue }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-lg-4 form-group">
                                                    ...
                                                    <input class="form-control" name="name" value="{{ $concern_info->name }}" placeholder="" type="text" required> 
                                                </div>
                                                <div class="col-lg-4 form-group">
