                ...
                <div class="page-header">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('propertycategory') }}" class="btn btn-primary my-2 btn-icon-text"> <i
                                    class="fe fe-plus me-2"></i>Parent
                                Category List</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            @foreach ($categories as $key => $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $parent = PropertyCategory::where(
                                                                'id',
                                                                $item->parent_id,
                                                            )->first();
                                                        @endphp

                                                        {{ !empty($parent) ? $parent->category_name : '' }}
                                                    ...
                                                    <td class="fw-medium">
                                                        ...
                                                        @if (count($totalSubMenus) != 0)
                                                            <p> <a href="{{ route('propertyCategory', $item->id) }}">Sub
                                                                    Category
                                                                    ({{ count($totalSubMenus) }})
                                                                </a>
                                                            </p>
                                                    ...
                                                    <td style="width:8%">
                                                        ...
                                                        <a href="javasctipt:void(0)"
                                                            ...
                                                            onclick="event.preventDefault(); if (confirm('Are you sure you want to delete?')) { document.getElementById('delete-item-form').submit(); }">
                                                            Delete
                                                        </a>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('savePropertyCategory') }}" method="POST" id="MasterForm" class="checkout-tab"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div>
                                    <input type="hidden" class="form-control" id="Mapcategoryid" name="Mapcategoryid"
                                        value="">
...
========================================================================== --}}
    ...
    <script>
        function editmapcategory(id) {
            ...
            jQuery.ajax({
                type: 'GET',
                url: "{{ url('admin/editmapcategory') }}?id=" + id,
                dataType: 'html',
                success: function(data) {
                    var x = JSON.parse(data);
                    $('#Mapcategoryid').val(x.id);
                    $('#work_category').val(x.work_category_id);
                    $('#sub_work_category').val(x.sub_work_category_id);
                    $('#sub_work_category').trigger('change');
                }
            }); //ajax close
