        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Edit Medical History Value</h2>
                        <ol class="breadcrumb">
                ...
                <!-- End Page Header -->
                <form action="{{ route('medicalhistory.update', $medicalhistory_info->id) }}" method="post"
                                        ...
                                        <div class="">
                                            <div class="row row-sm">
                                                <div class="col-lg-12 form-group">
                                                    ...
                                                    <select class="form-control select select2" name="medical_history" required>
                                                        ...
                                                        @foreach ($medical_historys as $item)
                                                            <option value="{{ $item->id }}" {{ $medicalhistory_info->medical_history == $item->id ? 'selected' : '' }}>{{ $item->MasterValue }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-lg-12 form-group">
                                                    ...
                                                    <input class="form-control" name="name" value="{{ $medicalhistory_info->name }}" placeholder="" type="text" required> 
                                                </div>
