        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Medical History Value ({{ @$medicalhistorysCount }})</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Medical History Value</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Medical History Value </li>
                        </ol>
                    </div>
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('medicalhistory.create') }}" type="button"
                                class="btn btn-primary my-2 btn-icon-text">
                                <i class="fe fe-plus me-2"></i> Add Medical History</a>
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body py-3">
                                <form action="{{ route('medicalhistory.index') }}" method="get">
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control select2" name="medical_history">
                                            <option value="">Medical History</option>
                                            @foreach ($medical_historys as $item)
                                                <option value="{{ $item->id }}" {{ $request->medical_history == $item->id ? 'selected' : '' }}>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                    ...
                                    <table class="table table-striped table-bordered text-nowrap mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><b>Medical History Value</b></th>
                                                <th width="15%"><b>Actions</b></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($medicalhistorys as $item)
                                                <tr>
                                                    <td>
                                                        MHV-{{ $item->id }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                           <b>{{ @$item->getMedicalHistory->MasterValue }}</b>
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <p class="mb-0">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('medicalhistory.edit', $item->id) }}" class="btn ripple btn-info btn-xs w-100">Edit</a>
                                                        <br>
                                                        ...
                                                        <form id="delete-item-form{{ $item->id }}"
                                                            action="{{ route('medicalhistory.destroy', $item->id) }}"
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    {!! $medicalhistorys->onEachSide(5)->appends(request()->input())->links('pagination::bootstrap-4') !!}
                                </div>
                            </div>
                        </div>
                    </div>
