        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Blog List ({{ @$blogsCount }})</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('blog.create') }}" type="button"
                                ...
                                <i class="fe fe-plus me-2"></i> Add Blog</a>
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img alt="avatar" class="rounded me-3"
                                                            src="{{ !empty($item->profile) ? asset('uploads/blog/' . $item->profile) : asset('uploads/userimage/no-blog.jpg') }}"
                                                            style="width:120px">
                                                        @else
                                                        NA
                                                        @endif
                                                    ...
                                                    <td>
                                                        <div class="main-toggle-group-demo">
                                                            ...
                                                            <a href="{{ url('admin/blog_status/' . $item->id) }}"
                                                        ...
                                                        <a href="{{ route('blog.edit', $item->id) }}" class="btn ripple btn-info btn-xs w-100">Edit</a><br>
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    {!! $blogs->onEachSide(5)->appends(request()->input())->links('pagination::bootstrap-4') !!}
                                </div>
                            </div>
                        </div>
                    </div>
