                                    ...
                                    <div class="">
                                        <div class="row row-sm ">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                ...
                                                <input class="form-control" name="blog_slug" value="{{ old('blog_slug') }}"
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Added Date: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" name="blog_date" 
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Alt Tag: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile_alt" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                            ...
                                            <div class="">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Name: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile2_name" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Alt Tag: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile2_alt" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                    ...
                                    <div class="">
                                        <div class="row row-sm ">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Blog Title: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" name="title_cn" value="{{ old('title_cn') }}"
                                                    placeholder="Enter" type="text" required>
                                                @error('title_cn')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="row row-sm">
                                                <div class="col-md-12 col-lg-12 col-sm-12 form-group">
                                                    <textarea class="form-control textarea"  name="description_cn" id="editor2" placeholder="" rows="8"></textarea>
                                            ...
                                            <div class="">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Name: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile_cn_name" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Alt Tag: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile_cn_alt" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                            ...
                                            <div class="">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Name: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile2_cn_name" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Alt Tag: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile2_cn_alt" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="row row-sm">
                                                <div class="col-md-12 col-lg-12 col-sm-12 form-group">
                                                    <textarea class="form-control textarea"  name="description_ar" id="editor3" placeholder="" rows="8"></textarea>
                                            ...
                                            <div class="">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Name: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile_ar_name" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Alt Tag: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile_ar_alt" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                            ...
                                            <div class="">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Name: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile2_ar_name" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">
                                                        <label class="form-label">Image Alt Tag: <span
                                                                class="tx-danger"></span></label>
                                                        <input class="form-control" name="profile2_ar_alt" 
                                                            placeholder="Enter" type="text" >
                                                    </div>
