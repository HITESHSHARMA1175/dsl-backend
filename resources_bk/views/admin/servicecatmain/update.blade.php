    ...
    <div class="main-content side-content pt-0">
        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <!-- End Page Header -->
                <form action="{{ route('servicecatmain.update', $servicecatmain_info->id) }}" method="post"
                            ...
                            <div class="row row-sm">
                                                ...
                                                <div class="row row-sm">
                                                    <div class="col-sm-12 col-md-12">
                                                        <input type="file" class="dropify" name="icon"
                                                            data-default-file="{{ !empty($servicecatmain_info->icon) ? asset('uploads/servicecatmain/' . $servicecatmain_info->icon) : asset('assets/img/media/1.jpg') }}"
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div>
                                                <h6 class="main-content-label mb-4">Category Details</h6>
                                            </div>
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Category Name: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" name="category_name" value="{{ $servicecatmain_info->category_name }}"
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Short Description: <span
                                                        class="tx-danger"></span></label>
                                                <input class="form-control" name="description" value="{{ $servicecatmain_info->description }}"
                                        ...
                                        <div class="row row-sm ">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Meta Title: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" name="meta_title" value="{{ $servicecatmain_info->meta_title }}"
                                                    placeholder="Enter" type="text" required>
                                                @error('meta_title')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Meta Keywords: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" name="meta_keywords" value="{{ $servicecatmain_info->meta_keywords }}"
                                                    placeholder="Enter" type="text" required>
                                                @error('meta_keywords')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Meta Description: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" name="meta_description" value="{{ $servicecatmain_info->meta_description }}"
                                                    placeholder="Enter" type="text" required>
