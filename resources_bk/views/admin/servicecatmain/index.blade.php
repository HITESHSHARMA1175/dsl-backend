        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Category List ({{ @$servicecatmainsCount }})</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('servicecatmain.create') }}" type="button"
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body py-3">
                                <form action="{{ route('servicecatmain.index') }}" method="get">
                                    <!--@csrf-->
                                    <div class="row">
                                        <div class="col-sm-4">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form method="POST" action="{{ route('servicecatmain_sorting') }}">
                                    @csrf
                                    <table class="table table-striped table-bordered text-nowrap mb-0">
                                        ...
                                        <tbody>
                                            @foreach ($servicecatmains as $item)
                                                <tr>
                                                    <td>
                                                        CAT-{{ $item->id }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img alt="avatar" class="rounded me-3"
                                                            src="{{ !empty($item->icon) ? asset('uploads/servicecatmain/' . $item->icon) : asset('uploads/userimage/no-servicecatmain.jpg') }}"
                                                            style="width:60px">
                                                        @else
                                                        NA
                                                        @endif
                                                    ...
                                                    <td>
                                                        <div class="main-toggle-group-demo">
                                                            ...
                                                            <a href="{{ url('admin/servicecatmain_status/' . $item->id) }}"
                                                        ...
                                                        <a href="{{ route('servicecatmain.edit', $item->id) }}"
                                                            class="btn ripple btn-info btn-xs w-100">Edit</a>
                                                        <br>
                                                        @if($item->servicecatmain_type != 'Home Section')   
                                                        <a href="#" class="btn ripple btn-danger btn-xs w-100" 
                                                           onclick="submitDeleteForm('{{ $item->id }}', '{{ route('servicecatmain.destroy', $item->id) }}')">
                                                           Delete
                                                        </a>
                                                        @endif
                                                    </td>
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    {!! $servicecatmains->onEachSide(5)->appends(request()->input())->links('pagination::bootstrap-4') !!}
                                </div>
                            </div>
                        </div>
                    </div>
