        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Add Treatment</h2>
                        <ol class="breadcrumb">
                                        ...
                                        <div class="">
                                            <div class="row row-sm">
                                                <div class="col-lg-12 form-group">
                                                    <label class="form-label">Treatment Type: <span class="tx-danger">*</span></label>
                                                ...
                                                <div class="col-lg-12 form-group">
                                                    ...
                                                    <input class="form-control" name="name" placeholder="Enter Treatment Name" type="text" required> 
                                                </div>
