    ...
    <div class="main-content side-content pt-0">
        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <!-- End Page Header -->
                <form action="{{ route('servicesubcat.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div>
                                                <h6 class="main-content-label mb-4">Sub Category Small Image</h6>
                                            </div>
                                            <div class="">
                                                <div class="row row-sm">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div>
                                                <h6 class="main-content-label  mb-3">Sub Category Details</h6>
                                            </div>
