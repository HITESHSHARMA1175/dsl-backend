            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="row row-sm">
                        <div class="col-lg-6 col-xl-5 d-none d-lg-block text-center ">
                            <div class="mt-5 pt-4 p-2 pos-absolute ">
                                ...
                                <h5 class="mt-4 text-dark">Signin to Your Account</h5>
                                <span class="text-dark-6 tx-13 mb-5 mt-xl-0">Signup to create, discover and connect with
                                        ...
                                        <form id="loginForm">
                                            ...
                                            <div class="form-group text-start">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button class="btn " type="button" id="togglePassword" style="background-color: #e8f0fe;">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                </div>
                                                <p id="passErr"></p>
                                            ...
                                            <a href="#"
                                                class="btn ripple btn-main-primary btn-block" id="userLogin">Sign In</a>
                                        </form>
                                        <div class="text-start mt-2 ms-0">
                                            <div class="mb-1"><a href="{{ route('forgot-password') }}">Forgot password?</a></div>
                    ...
                    error: function(response) {
                        ...
                        if (response.responseJSON.error) {
                            ...
                            if (response.responseJSON.error.password) {
                                $("#password").after(
                                    '<span class="text-danger errors" style="color:red">' +
                                    response.responseJSON.error.password + '</span>');
                            }
