        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Brand List ({{ @$brandsCount }})</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('brands.create') }}" type="button"
                                ...
                                <i class="fe fe-plus me-2"></i> Add Brand</a>
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img alt="avatar" class="rounded me-3"
                                                            src="{{ !empty($item->profile) ? asset('uploads/mobile/' . $item->profile) : asset('uploads/userimage/no-banner.jpg') }}"
                                                            style="width:60px">
                                                        @else
                                                        NA
                                                        @endif
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('brands.edit', $item->id) }}" class="btn ripple btn-info btn-xs w-100">Edit</a>
                                                        <br>
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    {!! $brands->onEachSide(5)->appends(request()->input())->links('pagination::bootstrap-4') !!}
                                </div>
                            </div>
                        </div>
                    </div>
