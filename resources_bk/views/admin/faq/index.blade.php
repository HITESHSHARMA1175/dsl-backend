        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Faq List ({{ @$faqsCount }})</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('faq.create') }}" type="button"
                                class="btn btn-primary my-2 btn-icon-text">
                                <i class="fe fe-plus me-2"></i> Add Faq</a>
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form method="POST" action="{{ route('faq_sorting') }}">
                                    @csrf
                                        ...
                                        <tbody>
                                            @foreach ($faqs as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            {{ @$item->getFaqCategory->category_name }}
                                                        </p>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="main-toggle-group-demo">
                                                            ...
                                                            <a href="{{ url('admin/faq_status/' . $item->id) }}"
                                                        ...
                                                        <a href="{{ route('faq.edit', $item->id) }}" class="btn ripple btn-info btn-xs w-100">Edit</a>
                                                        <br>
                                                         
                                                        <a href="#" class="btn ripple btn-danger btn-xs w-100" 
                                                           onclick="submitDeleteForm('{{ $item->id }}', '{{ route('faq.destroy', $item->id) }}')">
                                                           Delete
                                                        </a>
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    {!! $faqs->onEachSide(5)->appends(request()->input())->links('pagination::bootstrap-4') !!}
                                </div>
                            </div>
                        </div>
                    </div>
