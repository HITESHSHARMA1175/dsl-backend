        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Add Seo</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                                    ...
                                    <div class="">
                                        <div class="row row-sm ">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Seo Category: <span class="tx-danger">*</span></label>
                                                <select class="form-control select select2" name="seo_category" required>
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Seo Title: <span
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div>
                                                <h6 class="main-content-label  mb-3">Seo Description</h6>
                                            </div>
                                            <div class="row row-sm">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div>
                                        <h6 class="main-content-label mb-3">Seo INFO (Urdu)</h6>
                                    </div>
                                    <div class="">
                                        <div class="row row-sm ">
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div>
                                                <h6 class="main-content-label  mb-3">Seo Description (Urdu)</h6>
                                            </div>
                                            <div class="row row-sm">
                                                <div class="col-md-12 col-lg-12 col-sm-12 form-group">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div>
                                        <h6 class="main-content-label mb-3">Seo INFO (Arabic)</h6>
                                    </div>
                                    <div class="">
                                        <div class="row row-sm ">
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div>
                                                <h6 class="main-content-label  mb-3">Seo Description (Arabic)</h6>
                                            </div>
                                            <div class="row row-sm">
                                                <div class="col-md-12 col-lg-12 col-sm-12 form-group">
