...
class NodemailerService {
    ...
    getSmtpAttempts() {
        ...
        if (isGsuite) {
            ...
            attempts.push({ host: 'smtp-relay.gmail.com', port: 465 }, { host: 'smtp-relay.gmail.com', port: 587 }, { host: 'smtp.gmail.com', port: 465 }, { host: 'smtp.gmail.com', port: 587 });
        }
        else {
            attempts.push({ host: 'smtp.gmail.com', port: 465 }, { host: 'smtp.gmail.com', port: 587 });
        }
        return attempts;
    }
    createTransporter(host, port) {
        const { user, pass } = this.getSmtpConfig();
...
<body style="margin: 0; padding: 0; background-color: #070C18; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #070C18; padding: 32px 16px;">
    ...
    async sendAdminCustomEmail(data) {
        if (!this.isConfigured()) {
          ...
          <tr>
            <td style="padding: 32px 28px;">
              ...
              <p style="margin: 24px 0 0 0; color: #94A3B8; font-size: 13px; line-height: 1.6; border-top: 1px solid #1F2D54; padding-top: 20px;">
                If you have any questions or need to get in touch with our team, please reply to this email or contact us at <a href="mailto:${escapeHtml(env_1.env.SMTP_USER)}" style="color: #D4AF37; text-decoration: none; font-weight: 600;">${escapeHtml(env_1.env.SMTP_USER)}</a>.
              </p>
            </td>
          </tr>
          <tr>
