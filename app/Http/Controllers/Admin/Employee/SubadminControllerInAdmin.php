...
class SubadminControllerInAdmin extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.subadmin.index', compact('employees','employeesCount','request'));
    }
    ...
    public function create()
    {
        ...
        $designations = Designation::where('status', 1)
            ->orderBy('name')
            ->get();
        return view('admin.subadmin.create', compact('fieldPersons', 'countries', 'designations', 'adminmenus'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $addEmp->save();
        return redirect(route('subadmin.create'))->with('success', 'User Has been Created Successfuly.');
    }
    ...
    public function edit(string $id)
    {
        ...
        $designations = Designation::where('status', 1)
            ->orderBy('name')
            ->get();
        return view('admin.subadmin.update', compact('fieldPersons', 'user', 'countries', 'states', 'cites', 'designations','adminmenus'));
    }
    ...
    public function subadmin_desable($id)
    {
        $data = User::find($id);
