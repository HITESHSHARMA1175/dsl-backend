...
class AttributesControllerInAdmin extends Controller
{
    /**
    ...
    public function edit(string $id)
    {
        ...
        $attributes = Attribute::orderByDesc('id')->get();
        return view('admin.attributes.attributes', compact('attributes', 'item'));
    }
    ...
    public function deletePropertyAttribute(Request $request)
    {
        if (!empty($request->id)) {
            $data = Attribute::find($request->id)->delete();
            return redirect()
                ->back()
