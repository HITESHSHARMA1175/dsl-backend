...
class DataDetailsController extends Controller
{
    ...
    {
        return view('admin.datacrm.leadDetail');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.datacrm.leadDetail', compact('sugestedproperties','leadDetail', 'leadJourney', 'properties', 'fieldPersons','builders'));
    }
