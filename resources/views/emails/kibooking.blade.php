...
<head>
    ...
    <title>DSL Booking Confirmation</title>
    <style>
        /* Reset styles */
        body, html {
            margin: 0;
...
<body>
    <div class="container">
        ...
        <div class="message">
            ...
            <p>Thank you for booking your service with our clinic.</p>

            <div class="details">
                <p><b>Booking Details:</b></p>
                <p>Booking Id: <b>{{ $clientData['bookingid'] }}</b></p>
                <p>Booking Amount: <b>£{{ $clientData['amount'] }}</b></p>
                <p>Booking Date: <b>{{ $clientData['date'] }}</b></p>
                <p>Booking Time: <b>{{ $clientData['time'] }}</b></p>
            </div>
