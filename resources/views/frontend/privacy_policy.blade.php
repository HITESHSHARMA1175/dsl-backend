...
<main class="dsl-page">
<section class="dsl-policy-wrap"><div class="dsl-policy-content">
...
<style>
  ...
  .dsl-policy-content h3:first-child {
    margin-top: 0;
    font-size: 42px;
    text-align: center;
    border-bottom: none;
  ...
  .dsl-policy-content p {
    margin-bottom: 24px;
  }

  .dsl-policy-content strong {
    color: #fff;
    font-weight: 600;
  }

  .dsl-policy-content ul {
    margin-bottom: 24px;
    padding-left: 24px;
  }
  
  .dsl-policy-content li {
    margin-bottom: 12px;
  }
