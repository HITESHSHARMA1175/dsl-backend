    ...
    <div class="offers__inner">
      ...
      <div class="offers__head">
        ...
        <div class="offers__controls">
          <a class="offers__viewall" href="shop">View all</a>
 ...
 @forelse($home_special_offer as $offer)
            ...
            <article class="offer" aria-label="{{ $offer->category_name }}">
                ...
                <div class="offer__media"
                     style="background-image:url('{{ asset('uploads/servicecat/'.$offer->icon_large) }}'); 
    ...
    <div class="promo__surface">
      <div class="promo__inner">
        <div class="promo__content">
          ...
          <a class="promo__cta" href="offers" style="background:#fff;color: #000;">Learn More</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="plans__surface">
      <div class="plans__inner">
        <div class="plans__content">
          ...
          <a class="plans__cta" href="book-free-consultation" style="background: #fff;color: #000;">Book a free consultation</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="featured__inner">
      ...
      <div class="featured__grid" aria-label="Featured cards">
        ...
        <article class="fcard" aria-label="Get 3 treatments of 3 areas annually, and save 15%">
          ...
          <div class="fcard__media" aria-hidden="true" style="background-image:url('{{ asset('uploads/evegrn-anti-wrinkle-exiting.jpg') }}');"></div>
