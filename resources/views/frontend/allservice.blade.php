...
<!--   <section class="hero-split">
    ...
    <section class="results-split" aria-label="Real Results">
        <div class="container">
           <h2 class="results-title">{{ $category_name11 }}</h2>
            ...
            <div>
              <div class="ba-wrap">
                <div class="ba-frame" data-ba>
                  ...
                  <img class="ba-img" src="{{ asset('uploads/servicecat/' . $category->image1) }}" alt="Before" />

                  <div class="ba-top" data-ba-top>
                    <img class="ba-img-top" src="{{ asset('uploads/servicecat/' . $category->image2) }}" alt="After" />
                  </div>
             ...
             <div>
              <div class="ba-wrap">
                <div class="ba-frame" data-ba>
                  <!-- Replace these two URLs with your real BEFORE/AFTER images -->
                  <img class="ba-img" src="{{ asset('uploads/servicecat/' . $category->image3) }}" alt="Before" />

                  <div class="ba-top" data-ba-top>
                    <img class="ba-img-top" src="{{ asset('uploads/servicecat/' . $category->image4) }}" alt="After" />
                  </div>
...
<div class="faq-item" aria-expanded="false">
    <button class="faq-btn" type="button" aria-controls="faq-{{ $key }}" aria-expanded="false">
    ...
    <div class="faq-panel" id="faq-{{ $key }}" role="region" aria-hidden="true">
        <div>
            {!! $faq->answer !!}
        </div>
    </div>
