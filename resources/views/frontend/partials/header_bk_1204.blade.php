          ...
          <div class="mega-menu" aria-label="Treatments mega menu">
            <div class="mega-menu__inner">
              <ul class="mega-menu__tabs" role="list">
                  ...
                  <li class="is-active">
                    <a href="{{ url('service-details-page?slug=hair-restoration') }}" class="mega-tab" data-panel="hair" aria-current="true">
                  ...
                  <li>
                    <a href="{{ url('service-details-page?slug=laser-hair-removal') }}" class="mega-tab" data-panel="laser">
                  ...
                  <li>
                    <a href="{{ url('service-details-page?slug=tattoo-removal') }}" class="mega-tab" data-panel="tattoo">
                  ...
                  <li>
                    <a href="{{ url('service-details-page?slug=skin-treatments') }}" class="mega-tab" data-panel="skin">
                  ...
                  <li>
                    <a href="{{ url('service-details-page?slug=body-sculpting') }}" class="mega-tab" data-panel="body">
                  ...
                  <li>
                    <a href="{{ url('service-details-page?slug=medical-injectables') }}" class="mega-tab" data-panel="medical">
                  ...
                  <li>
                    <a href="{{ url('service-details-page?slug=dermatology') }}" class="mega-tab" data-panel="derma">
...
<div class="drawer" id="mobileNav" aria-hidden="true">
  ...
  <!-- Bag Drawer (right side) -->
  <div class="bag-overlay" data-bag-close hidden></div>
  <aside class="bag-drawer" aria-label="Bag" aria-hidden="true">
    <div class="bag-head">
      <h2 class="bag-title">Bag</h2>
      <button class="bag-close" type="button" aria-label="Close bag" data-bag-close>×</button>
    </div>
    ...
    <div class="bag-footer">
      <div class="bag-subtotal">
        <div class="bag-subtotal__label">Bag subtotal:</div>
        <div class="bag-subtotal__value" id="bagSubtotal">£0.00</div>
      </div>
      <div class="bag-note">Delivery and discounts are added at checkout.</div>
      <a class="bag-checkout" href="checkout.php">Checkout →</a>
    </div>
  </aside>
...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .mega-panel{
    display:none;
    grid-template-columns:repeat(3, minmax(180px, 1fr)) 250px;
    gap:30px;
    align-items:start;
  }
