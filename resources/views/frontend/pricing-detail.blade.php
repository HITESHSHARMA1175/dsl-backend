  ...
  <div class="dsl-page dsl-reset">
    ...
    <main class="dsl-main">
      <section class="faq-hero">
       <h1>Categories</h1>
<p>Find what you're looking for by browsing our categories below.</p>
      </section>
            ...
            @foreach($childCat as $category)
              ...
              <article class="faq-card">
                ...
                <div class="card-footer">
                  <a class="btn-viewall" href="/<?= $category['category_slug']?>">
                    <span>Price Details</span> <span class="arrow">→</span>
                  </a>
                </div>
