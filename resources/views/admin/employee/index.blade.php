        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Staff List ({{ @$employeesCount }})</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="add-employee.html" type="button" class="btn btn-primary my-2 btn-icon-text"> <i
                                    class="fe fe-plus me-2"></i> Add Staff</a> --}}
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body py-3">
                                <form action="{{ route('employee.show', $user_type) }}" method="get">
                                <!--@csrf-->
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 form-group" style="pointer-events: none;">
                                    ...
                                    <div class="col-sm-3 form-group">
                                        <select class="form-control select select2" name="designation">
                                            ...
                                            @foreach ($designations as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $request->designation == $item->id ? 'Selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <tbody>
                                            @foreach ($employees as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            <b>Address:</b> {{ $item->location_address }}<br>
                                                            <b>Date:</b> {{ $item->location_date }}<br>
                                                            <b>Time:</b> {{ $item->location_time }}<br>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('getUserMap', $item->id) }}"
                                                            class="btn ripple btn-info btn-xs w-100 mb-1">Live Location</a>
                                                        <br>
