        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Add Brand</h2>
                        <ol class="breadcrumb">
                                        ...
                                        <div class="">
                                            <div class="row row-sm">
                                                <div class="col-lg-12 form-group">
                                                    ...
                                                    <input class="form-control" name="name" placeholder="Enter Brand Name" type="text" required> 
                                                </div>
                                                <div class="col-lg-12 form-group">
                                                    <label class="form-label">Upload Brand Images <span class="tx-danger">*</span></label>
                                                    <input class="form-control" name="profile" placeholder="Enter Brand Name" type="file" required> 
                                                </div>
