        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Consultation Refer List ({{ @$consultationformsCount }})</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Consultation Refer </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Consultation Refer List </li>
                        </ol>
                    </div>
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <!--<a href="{{ route('consultation-form.create') }}" type="button"
                                class="btn btn-primary my-2 btn-icon-text">
                                <i class="fe fe-plus me-2"></i> Add Consultation Form</a>-->
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body py-3">
                                <form action="{{ route('consultation-refer') }}" method="get">
                                <div class="row">
                                    <div class="col-sm-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered  mb-0">
                                        ...
                                        <tbody>
                                            @foreach ($consultationforms as $item)
                                                <tr>
                                                    <td>
                                                        CF-{{ $item->id }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                           ...
                                                           <b>Friend Name: </b>{{ $item->last_name }}<br>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                           {{ $item->getConsultationClinic->clinic_name }}
                                                        </p>
                                                    </td>
                                                    
                                                    <td>
                                                        <p class="mb-0">
                                                           {{ $item->getConsultationService->category_name }}
                                                    ...
                                                    <td>
                                                        ...
                                                        <!--<a href="{{ route('consultation-form.edit', $item->id) }}" class="btn ripple btn-info btn-xs w-100">Edit</a>
                                                        <br>-->
                                                        ...
                                                        <form id="delete-item-form{{ $item->id }}"
                                                            action="{{ route('consultation-form.destroy', $item->id) }}"
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    {!! $consultationforms->onEachSide(5)->appends(request()->input())->links('pagination::bootstrap-4') !!}
                                </div>
                            </div>
                        </div>
                    </div>
