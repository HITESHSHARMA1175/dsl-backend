        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Subscribed Form List ({{ @$consultationformsCount }})</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Subscribed Form </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Subscribed Form List </li>
                        </ol>
                    </div>
                    <div class="d-flex">
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body py-3">
                                <form action="{{ route('subscribed-form') }}" method="get">
                                <div class="row">
                                    <div class="col-sm-4">
