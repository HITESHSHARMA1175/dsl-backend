                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Answer: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" name="answer" value="{{ old('answer') }}"
                                                    placeholder="Enter" type="text" required>
                                                @error('answer')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Question: <span
                                                        class="tx-danger"></span></label>
                                                <input class="form-control" name="question_cn" value="{{ old('question_cn') }}"
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Answer: <span
                                                        class="tx-danger"></span></label>
                                                <input class="form-control" name="answer_cn" value="{{ old('answer_cn') }}"
                                                    placeholder="Enter" type="text" >
                                                @error('answer_cn')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Question: <span
                                                        class="tx-danger"></span></label>
                                                <input class="form-control" name="question_ar" value="{{ old('question_ar') }}"
                                                    placeholder="Enter" type="text" >
                                                @error('question_ar')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <label class="form-label">Answer: <span
                                                        class="tx-danger"></span></label>
                                                <input class="form-control" name="answer_ar" value="{{ old('answer_ar') }}"
                                                    placeholder="Enter" type="text" >
                                                @error('answer_ar')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
