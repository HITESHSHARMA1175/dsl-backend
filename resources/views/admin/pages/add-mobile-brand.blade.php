            ...
            <div class="main-container container-fluid">
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div>
                            <h2 class="main-content-title tx-24 mg-b-5">Add Mobile Brand</h2>
                            <ol class="breadcrumb">
                        ...
                        <div class="row row-sm">
                            <!-- <div class="col-xl-4 col-lg-4 col-md-4">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div>
                                            <h6 class="main-content-label mb-4">Upload Brand Images</h6> </div>
                                        <div class="">
                                            <div class="row row-sm">
                                        ...
                                        <div class="">
                                            <div class="row row-sm">
                                                <div class="col-lg-12 form-group">
                                                    ...
                                                    <input class="form-control" name="first_name" value="" placeholder="Enter Brand Name" type="text"> </div>
                                                <div class="col-lg-12 form-group">
                                                    <label class="form-label">Upload Brand Images <span class="tx-danger">*</span></label>
                                                    <input class="form-control" name="first_name" value="" placeholder="Enter Brand Name" type="file"> </div>
