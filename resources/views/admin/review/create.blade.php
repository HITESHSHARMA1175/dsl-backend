                                        ...
                                        <div class="">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-lg-4 form-group">
                                                    ...
                                                    <input class="form-control" name="full_name" placeholder="Enter" type="text" required> 
                                                </div>
                                                <div class="col-lg-4 form-group">
                                                ...
                                                <div class="col-lg-4 form-group">
                                                    ...
                                                    <input class="form-control" name="adddate" placeholder="Enter" type="date" value="{{ date("Y-m-d") }}"> 
                                                </div>
