                ...
                <div class="page-header">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('inventorycategory') }}" class="btn btn-primary my-2 btn-icon-text"> <i
                                        ...
                                        <tbody>
                                            @foreach ($categories as $key => $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $parent = InventoryCategory::where('id', $item->parent_id)->first();
                                                        @endphp
                                                    ...
                                                    <td class="fw-medium">
                                                        ...
                                                        @if (count($totalSubMenus) != 0)
                                                            <p> <a href="{{ route('inventoryCategory', $item->id) }}">Sub
                                                                    Category
                                                                    ({{ count($totalSubMenus) }})
                                                                </a>
                                                            </p>
