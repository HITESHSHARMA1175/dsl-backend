        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Professional List ({{ @$professionalCount }})</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('professional.create') }}" type="button"
                                class="btn btn-primary my-2 btn-icon-text">
                                <i class="fe fe-plus me-2"></i> Add Professional</a>
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body py-3">
                                <form action="{{ route('professional.index') }}" method="get">
                                    <!--@csrf-->
                                    <div class="row">
                                        <div class="col-sm-4">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                                ...
                                                @foreach ($professionals as $item)
                                                    <tr>
                                                        ...
                                                        <td><img alt="avatar" class="rounded me-3"
                                                                src="{{ !empty($item->profile) ? asset('uploads/professional/' . $item->profile) : asset('assets/img/media/1.jpg') }}"
                                                                style="width:60px"></td>
                                                        <td>
                                                            {{ @$item->getProfessionalService->property_name }}
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="main-toggle-group-demo">
                                                                <a href="{{ url('admin/professional_status/' . $item->id) }}"
                                                            ...
                                                            <a href="{{ route('professional.edit', $item->id) }}"
                                                                class="btn ripple btn-info btn-xs w-100">Edit
                                                            </a>
                                                            <br>

                                                            {{-- <a href="{{ route('professional.show', $item->id) }}"
                                                            ...
                                                            <form id="delete-item-form{{ $item->id }}"
                                                                action="{{ route('professional.destroy', $item->id) }}"
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    {!! $professionals->onEachSide(5)->appends(request()->input())->links('pagination::bootstrap-4') !!}
                                </div>
                            </div>
                        </div>
                    </div>
