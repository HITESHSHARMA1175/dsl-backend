        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Variant List ({{ @$variantsCount }})</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="{{ route('variants.create') }}" type="button"
                                class="btn btn-primary my-2 btn-icon-text">
                                <i class="fe fe-plus me-2"></i> Add Variant</a>
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($variants as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(!empty(@$item->getVariantBrand->profile))
                                                        <img alt="avatar" class="rounded me-3"
                                                            src="{{ !empty($item->getVariantBrand->profile) ? asset('uploads/mobile/' . $item->getVariantBrand->profile) : asset('uploads/userimage/no-banner.jpg') }}"
                                                            style="width:60px">
                                                        @else
                                                        NA
                                                        @endif
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                           <b>{{ @$item->getVariantBrand->name }}</b>
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <p class="mb-0">
                                                           <b>{{ @$item->getVariantModel->name }}</b>
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <p class="mb-0">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('variants.edit', $item->id) }}" class="btn ripple btn-info btn-xs w-100">Edit</a>
                                                        <br>
                                                        ...
                                                        <form id="delete-item-form{{ $item->id }}"
                                                            action="{{ route('variants.destroy', $item->id) }}"
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    {!! $variants->onEachSide(5)->appends(request()->input())->links('pagination::bootstrap-4') !!}
                                </div>
                            </div>
                        </div>
                    </div>
