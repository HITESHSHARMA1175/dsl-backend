        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Update Seller</h2>
                        <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h6 class="main-content-label mb-1">Shop Details</h6>
                                    </div>
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-sm-6 mg-t-10">
                                            <div class="form-group mb-0">
                                                ...
                                                <input class="form-control" value="{{ $user->shop_name }}" name="shop_name"
                                                    type="text">
                                            </div>
                                            @error('shop_name')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-sm-6 mg-t-10">
                                            <div class="form-group mb-0">
                                                ...
                                                <input class="form-control" value="{{ $user->shop_gst }}" name="shop_gst"
                                                    type="text">
                                            </div>
                                            @error('shop_gst')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-sm-6 mg-t-10">
                                            <div class="form-group mb-0">
                                                ...
                                                <input class="form-control" value="{{ $user->shop_pan }}" name="shop_pan"
                                                    type="text">
                                            </div>
                                            @error('shop_pan')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-sm-6 mg-t-10">
                                            <div class="form-group mb-0">
                                                ...
                                                <input class="form-control" value="{{ $user->shop_business_no }}" name="shop_business_no"
                                                    type="text">
                                            </div>
                                            @error('shop_business_no')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input class="form-control" value="{{ $user->bank_name }}" name="bank_name" type="text"> </div>
                                            </div>
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    <label class="form-label">Account Holder Name</label>
                                                    <input class="form-control" value="{{ $user->account_name }}" name="account_name" type="text"> </div>
                                            </div>
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    <label class="form-label">⁠Bank Account Number</label>
                                                    <input class="form-control" value="{{ $user->account_no }}" name="account_no" type="text"> </div>
                                            </div>
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    <label class="form-label">⁠IFSC Code</label>
                                                    <input class="form-control" value="{{ $user->ifcs }}" name="ifcs" type="text"> </div>
                                            </div>
                                            <div class="col-sm-12 mg-t-10">
                                                <div class="form-group mb-0">
                                                    <label class="form-label">Branch Adresss</label>
                                                    <input class="form-control" value="{{ $user->bank_address }}" name="bank_address" type="text"> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input class="form-control" value="{{ $user->aadhar_number }}" name="aadhar_number" type="text"> </div>
                                            </div>
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    <label class="form-label">Enter Pan Number</label>
                                                    <input class="form-control" value="{{ $user->pan_number }}" name="pan_number" type="text"> </div>
                                            </div>
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    <label class="form-label">⁠Upload Aadhar Card</label>
                                                    <input class="form-control" name="upload_aadhaar" type="file"> </div>
                                                <img style="width:100px" src="{{ !empty($user->upload_aadhaar) ? asset('uploads/userimage/' . $user->upload_aadhaar) : asset('uploads/userimage/no-banner.jpg') }}">
                                            </div>
                                            <div class="col-sm-6 mg-t-10">
                                                <div class="form-group mb-0">
                                                    <label class="form-label">Upload Pan Card</label>
                                                    <input class="form-control" name="upload_pan" type="file"> </div>
                                                <img style="width:100px" src="{{ !empty($user->upload_pan) ? asset('uploads/userimage/' . $user->upload_pan) : asset('uploads/userimage/no-banner.jpg') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        $(function() {
            ...
            let preloaded = [
                @foreach ($shopimages as $item)
                    {
                        id: '{{ $item->id }}',
                        src: '{{ asset('uploads/shop/' . $item->image) }}'
                    },
                @endforeach
            ];
