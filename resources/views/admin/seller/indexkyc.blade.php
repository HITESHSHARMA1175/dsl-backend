        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Seller List ({{ @$employeesCount }})</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a href="add-employee.html" type="button" class="btn btn-primary my-2 btn-icon-text"> <i
                                    class="fe fe-plus me-2"></i> Add Seller</a> --}}
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-end">
                                        <a href="{{ route('seller.create') }}" class="btn btn-primary btn-icon-text newbtn">Create Seller</a>
                                    </div>
                                </div>
                                </form>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($employees as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            <b>Shop Name:</b> {{ $item->shop_name }}<br>
                                                            <b>Shop GST Number:</b> {{ $item->shop_gst }}<br>
                                                            <b>Shop Pan Number:</b> {{ $item->shop_pan }}<br>
                                                            <b>Shop Business Number:</b> {{ $item->shop_business_no }}<br>
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <p class="mb-0">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('admin/seller_kyc_approve/' . $item->id) }}"
                                                            class="btn ripple  btn-xs w-100 mb-1 {{ $item->is_kyc == 0 ? 'btn-success' : 'btn-danger' }}">
                                                            {{ $item->is_kyc == 0 ? 'Approve' : 'Approved' }}</a>
                                                        <br>
                                                        
                                                        <!--<a href="{{ route('seller.edit', $item->id) }}"
                                                        ...
                                                        <form id="delete-item-form{{ $item->id }}"
                                                            action="{{ route('seller.destroy', $item->id) }}"
